...
datatableproc.txt, backpropagation.txt and loadsaveweights.txt in test/legacy/automation.
"""
...
FIXTURES = REPO / "test/legacy/automation/EmergentTestFramework/test-projects"
