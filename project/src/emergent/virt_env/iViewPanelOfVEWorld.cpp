...
iViewPanelOfVEWorld::iViewPanelOfVEWorld(VEWorldView* dv_)
:inherited(dv_)
{
...
iViewPanelOfVEWorld::~iViewPanelOfVEWorld() {
  VEWorldView* wv_ = wv();
  if (wv_) {
    wv_->m_wvp = NULL;
  }
...
void iViewPanelOfVEWorld::UpdatePanel_impl() {
...
void iViewPanelOfVEWorld::GetValue_impl() {
