...
// {
  ...
  INLINE void  Compute_dWt(CON_STATE* cg, NETWORK_STATE* net, int thr_no) override { (void)cg; (void)net; (void)thr_no; };
  INLINE void  Compute_Weights(CON_STATE* cg, NETWORK_STATE* net, int thr_no) override { (void)cg; (void)net; (void)thr_no; };
