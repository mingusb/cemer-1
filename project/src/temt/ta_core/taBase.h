...
public:
  ...
  virtual bool          OpenInWindow(bool modal = false);
  ...
  virtual bool          BrowserEditMe();
  // #CAT_Display select this item and open for edit (only works if gui is active, etc) -- returns success
