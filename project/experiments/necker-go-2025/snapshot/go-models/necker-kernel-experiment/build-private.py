...
root=Path('/home/b/cemer');out=root/'artifacts/go-models/necker-kernel-experiment';build=root/'build-modern-final';source=root/'project';private=out/'prefix';private.mkdir(exist_ok=True);(private/'lib').mkdir(exist_ok=True)
