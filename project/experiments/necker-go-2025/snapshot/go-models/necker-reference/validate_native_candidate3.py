...
root=Path('/home/b/cemer');base=root/'artifacts/go-models';args=SimpleNamespace(output=base/'necker-native-validation3',binary=root/'project/tools/run-emergent',timeout=360)
...
try:
 for name,noise,adapt,quarter in [('zero-noise',0,False,25),('zero-noise-adaptation',0,True,250),('authored-default',.01,False,25),('authored-adaptation',.01,True,250)]:
  c=Case(args,name);c.fixture=c.directory/'necker_cube.proj';shutil.copy2(base/'necker-native-candidate2/necker_cube.proj',c.fixture)
