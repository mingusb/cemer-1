...
root=Path('/home/b/cemer');base=root/'artifacts/go-models';args=SimpleNamespace(output=base/'necker-native-validation5',binary=root/'project/tools/run-emergent',timeout=360)
