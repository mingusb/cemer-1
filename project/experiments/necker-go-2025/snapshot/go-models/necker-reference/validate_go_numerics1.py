...
root=Path('/home/b/cemer');base=root/'artifacts/go-models';args=SimpleNamespace(output=base/'necker-go-numerics-validation1',binary=root/'project/tools/run-emergent',timeout=360)
...
try:
 for name,noise,adapt,quarter in [('authored-high-noise',.1,False,25),('authored-low-noise',.001,False,25),('authored-adaptation',.01,True,250)]:
