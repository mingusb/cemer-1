...
root=Path('/home/b/cemer');base=root/'artifacts/go-models';args=SimpleNamespace(output=base/'necker-native-validation6-noise-exercises',binary=root/'project/tools/run-emergent',timeout=360)
...
try:
 for name,noise,adapt,quarter in [('authored-high-noise',.1,False,25),('authored-low-noise',.001,False,25)]:
  c=Case(args,name);c.fixture=c.directory/'necker_cube.proj';shutil.copy2(base/'necker-native-candidate4/necker_cube.proj',c.fixture)
