...
root=Path('/home/b/cemer');base=root/'artifacts/go-models';args=SimpleNamespace(output=base/'necker-kernel-validation1',binary=root/'project/tools/run-emergent',timeout=360)
