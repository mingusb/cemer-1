...
#include "taiEditorOfControlPanelBase.h"
...
taiEditorOfControlPanelBase::taiEditorOfControlPanelBase(void* base, TypeDef* td,
...
void taiEditorOfControlPanelBase::Constr_Methods_impl() {
