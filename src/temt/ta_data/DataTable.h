...
public:
  ...
  virtual String          SaveDataLogNameFmProject
  ...
  virtual String          SaveDataNameFmProject
    (const String& ext, const String& tag = "", const String& subdir = "",
     bool dmem_proc_0 = true);
  // #CAT_File save current data in table to a file using standard Emergent formatting options -- gets the file name by calling GetFileNameFmProject with ext extension, special tag name for this run / job, and any subdirectory to append -- returns the file name
