...
//{
  ...
  INLINE virtual int  GetStateSpecType() const { return NETWORK_STATE::T_LayerSpec; }
  // #CAT_State derived classes MUST override this and pass correct global type id

  INLINE virtual void Init_LayerState(LAYER_STATE* lst, NETWORK_STATE* net) { (void)lst; (void)net; };
